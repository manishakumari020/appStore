...
class AppStore extends Component {
  ...
  getActiveTab = searchedApps => {
    ...
    const filteredActiveTab = searchedApps.filter(
      eachSearch => eachSearch.category === activeTabId,
    )
    return filteredActiveTab
  }
  ...
  render() {
    ...
    const filteredActiveTab = this.getActiveTab(searchResults)
